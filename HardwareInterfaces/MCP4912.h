...
public:
    ...
    static const uint8_t GAIN_1;     // output = 1 * ( VREF*D/4096 )
    static const uint8_t GAIN_2;     // output = 2 * ( VREF*D/4096 )
     ...
     * @param value Value to write. Max 4096. Vout = GAIN * VREF*D/4096 
